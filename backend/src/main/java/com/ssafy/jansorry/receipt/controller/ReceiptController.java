...
public class ReceiptController {
	...
	public ResponseEntity<Long> addReceipt(    //ResponseEntity: 결과 데이터와 HTTP 상태 코드를 직접 제어할 수 있는 클래스
		...
		@RequestBody ReceiptSaveDto receiptSaveDto    //@RequestBody: HTTP 요청 바디 값을 컨트롤러 메서드의 매개 변수로 받을 수 있음
	) {
	...
	public ResponseEntity<ReceiptResponse> getReceipt(
		...
		ReceiptResponse receiptResponse = receiptService.readReceipt(member, seq - 1);
